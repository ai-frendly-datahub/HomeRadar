...
from homeradar.resilience import get_circuit_breaker_manager


_exceptions_module = __import__(
    "homeradar.exceptions",
    fromlist=["NetworkError", "ParseError", "SourceError"],
)
NetworkError = _exceptions_module.NetworkError
ParseError = _exceptions_module.ParseError
SourceError = _exceptions_module.SourceError
